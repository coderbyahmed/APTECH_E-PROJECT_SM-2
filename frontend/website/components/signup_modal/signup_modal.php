                ...
                <div class="wg-signup-form__row">
                    <div class="wg-signup-form__field">
                        ...
                        <div class="wg-signup-form__input-wrap">
                            ...
                            <input type="tel" class="wg-signup-form__input" id="signupPhone" name="phone" placeholder="e.g. 03178497732 or +923178497732" required maxlength="13" inputmode="tel" pattern="(0\d{10}|\+92\d{10})">
                        </div>
                    </div>
                    <div class="wg-signup-form__field">
