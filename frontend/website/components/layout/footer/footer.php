    ...
    <div class="wg-footer__inner">
        <div class="wg-footer__top">
            ...
            <div class="wg-footer__brand">
                ...
                <p class="wg-footer__desc">Discover music, videos, artists and more — all in one place. Your ultimate destination for streaming and exploring sound.</p>
            </div>
            ...
            <div class="wg-footer__col">
                ...
                <div class="wg-footer__social">
                    <a href="#" class="wg-footer__social-link" aria-label="Facebook" target="_blank" rel="noopener">
                    ...
                    <a href="#" class="wg-footer__social-link" aria-label="TikTok" target="_blank" rel="noopener">
                    ...
                    <a href="#" class="wg-footer__social-link" aria-label="LinkedIn" target="_blank" rel="noopener">
                    ...
                    <a href="#" class="wg-footer__social-link" aria-label="GitHub" target="_blank" rel="noopener">
        ...
        <div class="wg-footer__bottom">
            <p class="wg-footer__copy">&copy; 2026 Sound Group. All Rights Reserved.</p>
        </div>
    </div>
</footer>
