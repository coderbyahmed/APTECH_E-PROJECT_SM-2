...
$wsContactEmail = htmlspecialchars($ws['contact_email']);
$wsContactPhone = htmlspecialchars($ws['contact_phone']);
$wsContactAddr  = htmlspecialchars($ws['contact_address']);
...
<head>
    ...
    <title>Contact - <?php echo $wsWebsiteName; ?></title>
...
<body class="wg-page--contact">
    ...
    <section class="wg-contact-hero">
        <div class="wg-contact-hero__inner">
            ...
            <h1 class="wg-contact-hero__title">Let's Connect With <span class="wg-contact-hero__title-accent">Sound
                    Group</span></h1>
            <p class="wg-contact-hero__desc">Have a question, suggestion, feedback, collaboration idea, or something
                you'd like to share? We'd love to hear from you.</p>
        </div>
    </section>
            ...
            <div class="wg-contact-main__grid">
                ...
                <div class="wg-contact-form-wrap" data-animate="fade-up">
                    <div class="wg-contact-form-card">
                        ...
                        <p class="wg-contact-form-card__desc">Fill out the form below and we'll get back to you as soon
                            as possible.</p>

                        <form class="wg-contact-form" id="contactForm" novalidate>
                            <!-- Full Name -->
                            <div class="wg-contact-form__field">
                                <label class="wg-contact-form__label" for="contactName">Full Name <span
                                ...
                                <div class="wg-contact-form__input-wrap">
                                    ...
                                    <input type="text" class="wg-contact-form__input" id="contactName" name="name"
                                        placeholder="Enter your full name" required>
                                </div>
                                <span class="wg-contact-form__field-error" id="contactNameError"></span>
                            </div>

                            <!-- Email -->
                            <div class="wg-contact-form__field">
                                <label class="wg-contact-form__label" for="contactEmail">Email Address <span
                                        class="wg-contact-form__required">*</span></label>
                                <div class="wg-contact-form__input-wrap">
                                    <span class="wg-contact-form__input-icon">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                    ...
                                    <input type="email" class="wg-contact-form__input" id="contactEmail" name="email"
                                        placeholder="Enter your email address" required>
                                </div>
                                <span class="wg-contact-form__field-error" id="contactEmailError"></span>
                            </div>
                            ...
                            <!-- Inquiry Type -->
                            <div class="wg-contact-form__field">
                                <label class="wg-contact-form__label" for="contactInquiry">Inquiry Type <span
                                        class="wg-contact-form__required">*</span></label>
                                <div class="wg-contact-form__input-wrap">
                                    <span class="wg-contact-form__input-icon">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                    ...
                                    <select class="wg-contact-form__input wg-contact-form__select" id="contactInquiry"
                                ...
                                <span class="wg-contact-form__field-error" id="contactInquiryError"></span>
                            </div>

                            <!-- Subject -->
                            <div class="wg-contact-form__field">
                                <label class="wg-contact-form__label" for="contactSubject">Subject <span
                                        class="wg-contact-form__required">*</span></label>
                                <div class="wg-contact-form__input-wrap">
                                    <span class="wg-contact-form__input-icon">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                    ...
                                    <input type="text" class="wg-contact-form__input" id="contactSubject" name="subject"
                                        placeholder="What is this about?" required>
                                </div>
                                <span class="wg-contact-form__field-error" id="contactSubjectError"></span>
                            </div>

                            <!-- Message -->
                            <div class="wg-contact-form__field">
                                <label class="wg-contact-form__label" for="contactMessage">Message <span
                                        class="wg-contact-form__required">*</span></label>
                                <div class="wg-contact-form__input-wrap wg-contact-form__input-wrap--textarea">
                                    ...
                                    <textarea class="wg-contact-form__input wg-contact-form__textarea"
                                        id="contactMessage" name="message" placeholder="Write your message here..."
                                        rows="5" required></textarea>
                                </div>
                                <span class="wg-contact-form__field-error" id="contactMessageError"></span>
                            </div>

                            <!-- Submit -->
                            <button type="submit" class="wg-btn wg-btn--primary wg-btn--lg wg-contact-form__submit"
                                id="contactSubmit">
                ...
                <div class="wg-contact-info" data-animate="fade-left">
                    ...
                    <div class="wg-contact-info__card wg-contact-info__card--whatsapp">
                        ...
                        <div class="wg-contact-info__card-content">
                            ...
                            <p class="wg-contact-info__card-text">Chat with us directly for quick questions and
                                inquiries.</p>
                            <a href="https://wa.me/923178497732?text=Hello%20Sound%20Group%2C%20I%20want%20to%20contact%20you."
                                class="wg-btn wg-btn--primary wg-contact-info__card-btn" id="whatsappBtn"
                    ...
                    <div class="wg-contact-info__card">
                        ...
                        <div class="wg-contact-info__card-content">
                            ...
                            <p class="wg-contact-info__card-text">Have something detailed to discuss? Send us an email.
                            </p>
                            <a href="mailto:<?php echo $wsContactEmail; ?>"
                                class="wg-contact-info__card-link"><?php echo $wsContactEmail; ?></a>
                        </div>
                    </div>
                    ...
                    <div class="wg-contact-info__card">
                        ...
                        <div class="wg-contact-info__card-content">
                            ...
                            <p class="wg-contact-info__card-text"><?php echo $wsContactAddr; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="wg-contact-info__card">
                        ...
                        <div class="wg-contact-info__card-content">
                            ...
                            <div class="wg-contact-info__social">
                                <a href="<?php echo $wsFacebook; ?>" class="wg-contact-info__social-link" aria-label="Facebook" target="_blank"
                                    rel="noopener">
                                    <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
                                        <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                                    </svg>
                                </a>
                                <a href="<?php echo $wsTiktok; ?>" class="wg-contact-info__social-link" aria-label="TikTok" target="_blank"
                                    rel="noopener">
                                    <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
                                        <path
                                ...
                                <a href="<?php echo $wsLinkedin; ?>" class="wg-contact-info__social-link" aria-label="LinkedIn" target="_blank"
                                    rel="noopener">
                                    <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
                                        <path
                                ...
                                <a href="<?php echo $wsGithub; ?>" class="wg-contact-info__social-link" aria-label="GitHub" target="_blank"
                                    rel="noopener">
                                    <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
                                        <path
                    ...
                    <div class="wg-contact-info__card wg-contact-info__card--cta">
                        ...
                        <p class="wg-contact-info__card-text">Whether you have feedback, a project idea, a business
                            opportunity, or simply want to connect with Sound Group, feel free to reach out.</p>
    ...
    <section class="wg-contact-whatsapp">
        <div class="wg-contact-whatsapp__inner">
            <div class="wg-contact-whatsapp__content" data-animate="fade-up">
                ...
                <a href="https://wa.me/923178497732?text=Hello%20Sound%20Group%2C%20I%20want%20to%20contact%20you."
                    class="wg-btn wg-btn--primary wg-btn--lg" id="whatsappBtnBottom" target="_blank" rel="noopener">
                    <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
                        <path
                            d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" />
                    </svg>
