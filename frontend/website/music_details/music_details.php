...
<body class="wg-page--details" data-music-id="<?php echo (int)$track['id']; ?>" data-handler-url="<?php echo baseUrl(); ?>/backend/handlers/review-handler.php" data-user-logged-in="<?php echo isUserLoggedIn() ? '1' : '0'; ?>">
