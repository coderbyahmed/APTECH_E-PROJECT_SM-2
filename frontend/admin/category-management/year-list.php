<?php
/**
 * SOUND Group — Category Management: Year List
 */
...
$pageTitle = 'Year List — Category Management';
$activeItem = 'category-management';

$db = getDb();
$stmt = $db->prepare("SELECT `id`, `name`, `created_at`, `updated_at` FROM `air` ORDER BY `id` DESC");
$stmt->execute();
...
<script>document.body.classList.add('cm-page','cm-page--year');</script>
    ...
    <div class="cm-header">
        <div class="cm-header__left">
            ...
            <h1 class="cm-header__title">Year List</h1>
            <p class="cm-header__subtitle">All year entries used for organizing content.</p>
        </div>
    </div>

    <div class="cm-table-card">
        <div class="cm-table-card__header">
            <h2 class="cm-table-card__title">All Years</h2>
            <div class="cm-table-card__search">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="16" height="16">
                    <circle cx="11" cy="11" r="8"/>
                    <line x1="21" y1="21" x2="16.65" y2="16.65"/>
                </svg>
                <input type="text" class="cm-search-input" placeholder="Search years..." id="cmSearchInput">
            </div>
        </div>
        ...
        <div class="cm-table-card__footer">
            <span class="cm-table-card__count">Showing <?php echo count($records); ?> year<?php echo count($records) !== 1 ? 's' : ''; ?></span>
        </div>
    </div>
    ...
    <div class="sg-modal" id="cmEditModal">
        ...
        <div class="sg-modal__dialog cm-modal">
            ...
            <div class="sg-modal__body">
                ...
                <h2 class="sg-modal__title">Edit Year</h2>
                <p class="sg-modal__subtitle">Update the year value.</p>
                <form id="cmEditForm" class="cm-form">
                    ...
                    <div class="sg-form-group">
                        <label class="sg-form-label" for="cm-edit-input">Year</label>
                        <input type="number" class="sg-form-input cm-form-input" id="cm-edit-input" min="1900" max="2099">
                    </div>
        ...
        <div class="sg-modal__dialog cm-modal cm-modal--delete">
            ...
            <div class="sg-modal__body">
                <div class="cm-delete-body">
                    ...
                    <h2 class="sg-modal__title">Delete Year</h2>
