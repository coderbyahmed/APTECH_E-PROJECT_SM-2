...
<div class="wi-header">
    <div class="wi-header__left">
        ...
        <p class="wi-header__subtitle">Manage general website information — company identity, home page headings,
            contact details, social links and footer text.</p>
    </div>
</div>
            ...
            <div class="wi-grid">
                <div class="wi-field">
                    ...
                    <span class="wi-field__value"
                        id="wiSiteNameValue"><?php echo htmlspecialchars($siteInfo['websiteName']); ?></span>
                </div>
                <div class="wi-field">
        ...
        <div class="wi-section__body">
            <div class="wi-grid">
                <div class="wi-field">
                    ...
                    <span class="wi-field__value"
                        id="wiContactEmailValue"><?php echo htmlspecialchars($contactInfo['email']); ?></span>
                </div>
                <div class="wi-field">
                    <span class="wi-field__label">Phone Number</span>
                    <span class="wi-field__value"
                        id="wiContactPhoneValue"><?php echo htmlspecialchars($contactInfo['phone']); ?></span>
                </div>
                <div class="wi-field wi-field--full">
                    <span class="wi-field__label">Address</span>
                    <p class="wi-field__text" id="wiContactAddressValue">
                        <?php echo htmlspecialchars($contactInfo['address']); ?></p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="wi-field">
                    <div class="wi-social__row">
                        ...
                        <div class="wi-social__meta">
                            ...
                            <span class="wi-social__url"
                                id="wiFacebookValue"><?php echo htmlspecialchars($socialLinks['facebook']); ?></span>
                        </div>
                    </div>
                </div>
                <div class="wi-field">
                    <div class="wi-social__row">
                        ...
                        <div class="wi-social__meta">
                            ...
                            <span class="wi-social__url"
                                id="wiGithubValue"><?php echo htmlspecialchars($socialLinks['github']); ?></span>
                        </div>
                    </div>
                </div>
                <div class="wi-field">
                    <div class="wi-social__row">
                        ...
                        <div class="wi-social__meta">
                            ...
                            <span class="wi-social__url"
                                id="wiLinkedInValue"><?php echo htmlspecialchars($socialLinks['linkedin']); ?></span>
                        </div>
                    </div>
                </div>
                <div class="wi-field">
                    <div class="wi-social__row">
                        ...
                        <div class="wi-social__meta">
                            ...
                            <span class="wi-social__url"
                                id="wiTikTokValue"><?php echo htmlspecialchars($socialLinks['tiktok']); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="wi-section__body">
            <div class="wi-grid">
                <div class="wi-field wi-field--full">
                    ...
                    <p class="wi-field__text" id="wiFooterDescValue">
                        <?php echo htmlspecialchars($footerInfo['desc']); ?></p>
                </div>
                <div class="wi-field wi-field--full">
                    <span class="wi-field__label">Copyright Text</span>
                    <span class="wi-field__value"
                        id="wiCopyrightValue"><?php echo htmlspecialchars($footerInfo['copyright']); ?></span>
                </div>
            </div>
        </div>
    </section>
...
<div class="sg-modal" id="wiSiteModal">
    ...
    <div class="sg-modal__dialog wi-modal wi-modal--wide">
        ...
        <div class="sg-modal__body">
            ...
            <p class="sg-modal__subtitle">Update the general identity and company details displayed across the website.
            </p>
            ...
            <form id="wiSiteForm" class="wi-form">
                <div class="wi-form__grid">
                    <div class="sg-form-group">
                        ...
                        <input type="text" class="sg-form-input wi-form-input" id="wiWebsiteName"
                            value="<?php echo htmlspecialchars($siteInfo['websiteName']); ?>">
                    </div>
                    <div class="sg-form-group">
                        ...
                        <div class="wi-file-field">
                            ...
                            <input type="file" class="wi-file-field__input" id="wiLogoInput"
                ...
                <div class="wi-form__grid">
                    <div class="sg-form-group">
                        ...
                        <div class="sg-form-input-wrap">
                            ...
                            <input type="email" class="sg-form-input" id="wiContactEmail"
                    ...
                    <div class="sg-form-group">
                        ...
                        <div class="sg-form-input-wrap">
                            ...
                            <input type="tel" class="sg-form-input" id="wiContactPhone"
                    ...
                    <div class="sg-form-group wi-form__group--full">
                        ...
                        <textarea class="sg-form-input wi-form-input wi-form-textarea" id="wiContactAddress"
                            rows="3"><?php echo htmlspecialchars($contactInfo['address']); ?></textarea>
                    </div>
                </div>
                ...
                <div class="wi-form__grid">
                    <div class="sg-form-group">
                        ...
                        <div class="sg-form-input-wrap">
                            ...
                            <input type="url" class="sg-form-input" id="wiFacebook"
                    ...
                    <div class="sg-form-group">
                        ...
                        <div class="sg-form-input-wrap">
                            ...
                            <input type="url" class="sg-form-input" id="wiGithub"
                    ...
                    <div class="sg-form-group">
                        ...
                        <div class="sg-form-input-wrap">
                            ...
                            <input type="url" class="sg-form-input" id="wiLinkedIn"
                    ...
                    <div class="sg-form-group">
                        ...
                        <div class="sg-form-input-wrap">
                            ...
                            <input type="url" class="sg-form-input" id="wiTikTok"
                                value="<?php echo htmlspecialchars($socialLinks['tiktok']); ?>"
                                placeholder="https://...">
                        </div>
                    </div>
                </div>
            ...
            <form id="wiFooterForm" class="wi-form">
                <div class="wi-form__grid">
                    <div class="sg-form-group wi-form__group--full">
                        ...
                        <textarea class="sg-form-input wi-form-input wi-form-textarea" id="wiFooterDesc"
                            rows="4"><?php echo htmlspecialchars($footerInfo['desc']); ?></textarea>
                    </div>
                    <div class="sg-form-group wi-form__group--full">
                        <label class="sg-form-label" for="wiCopyright">Copyright Text</label>
                        <input type="text" class="sg-form-input wi-form-input" id="wiCopyright"
                            value="<?php echo htmlspecialchars($footerInfo['copyright']); ?>"
                            placeholder="© 2026 SOUND Group. All rights reserved.">
                    </div>
                </div>
