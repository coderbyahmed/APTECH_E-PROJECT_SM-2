...
<head>
    ...
    <title>Access Denied — SOUND Group</title>
    <style>
...
<body>
    <div class="error-container">
        ...
        <p class="error-desc">You don't have permission to access this page. If you believe this is an error, please contact the administrator.</p>
