...
<head>
    ...
    <title>Service Unavailable — SOUND Group</title>
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-icon { display: inline-flex; align-items: center; justify-content: center; width: 72px; height: 72px; border-radius: 20px; background: rgba(245,158,11,0.12); border: 1px solid rgba(245,158,11,0.2); margin-bottom: 1.5rem; }
        .error-icon svg { width: 36px; height: 36px; color: #f59e0b; }
...
<body>
    <div class="error-container">
        ...
        <h1 class="error-heading">Service Temporarily Unavailable</h1>
        <p class="error-desc">We're having trouble connecting to the service right now. Please try again later.</p>
